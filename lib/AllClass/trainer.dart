...
Future<List<Trainer>> fetchTrainers(int userId) async {
  final response = await http.get(Uri.parse(
      'http://192.168.1.50/EduPlatform/CMS/api/TrainersCrudOperation.php?operation=SelectOne&UserID=$userId'));
...
Future<void> getTrainer() async {
  try {
    Uri url = Uri.parse('http://192.168.1.50/EduPlatform/CMS/api/TrainersCrudOperation.php?operation=SelectAll');
